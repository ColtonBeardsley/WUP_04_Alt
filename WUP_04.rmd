...
By lookin at the box plot graph, its not clear enough if there is a significant difference between the WHITE and OTHER races. It is also not clear enough if there is a difference between the BLACK and OTHER races.
